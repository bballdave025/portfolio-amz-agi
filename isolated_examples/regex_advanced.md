...
figure out the basics, and pull out at least one example of: 1) Looking for non-ASCII and ASCII-but-control-character-or-space, fixing;
2) Looking for my no-no characters, those that I don't like to have in a filename because of possible parsing problems. If we can get 
that with enough context to make it understandable, that's great! 
